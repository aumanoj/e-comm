...
<input type="text" name="heading" value="<?php echo set_value('heading',$RefundPolicy['heading']); ?>" class="form-control" placeholder="Enter Heading">
</div>
        ...
        <div class="col-md-12">
          ...
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                <textarea class="textarea form-control" name="description" style="width: 500%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo set_value('description',$RefundPolicy['description']); ?></textarea>
              </div>
              <?php 
