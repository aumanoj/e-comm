<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('assets/vendors/flexslider/flexslider.css')}}"
        media="screen" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3 logo">
                        <a href="{{url('/')}}" class="logo_a"><img src="{{asset('assets/images/dshine-logo.png')}}"
                                alt="Bansal & Sons">
                        </a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <div style="display:inline-block; padding-top:10px;">
                                    <img class="img-responsive" src="{{asset('assets/images/dshine-logo.png')}}"
                                        width="100" height="100" alt="Bansal & Sons">
                                </div>
                            </div>
                                        ...
                                        <a href="#" title="Rings">
                                            ...
                                            <span class="jwellery-icons-mobile">
                                                <img class="img-responsive"
                                                    src="{{asset('assets/images/icons/ring.png')}}" width="25"
                                                    height="25">
                                            </span>
                                            <span></p></span>
                                        </a>
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown megaMenu">
                            <a onmouseover="" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-expanded="false">{{$categorie->name}}</a>
