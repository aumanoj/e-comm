  ...
  <footer class="row">
                  ...
                  <div class="col-sm-4 footFeature">
                     <div class="media m0">
                        ...
                        <div class="media-body texts">
                           ...
                           <h2 class="footer-info-h2" style="font-size: initial;">sales@bansalandsonsjewellers.com</h2>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-4 footFeature">
         ...
         <div class="row m0 copyRight">
            <div class="container">
               <div class="row">
                  <div class="fleft">&copy; 2021 <a href="index.php">Bansal and Sons Jewellers</a> All Rights Reserved. Developed & Managed By <a href="#">JavaTpoint</a> </div>
