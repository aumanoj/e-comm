       ...
       <div id="trigger" class="container ">
           <div class="row">
               ...
               <div class="col-md-6  ring_cont">
                   ...
                   <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In pellentesque, diam viverra lacinia
                       sodales, elit turpis consequat sapien, nec feugiat ex urna quis libero. Sed vel purus iaculis,
                       lobortis neque vel, commodo enim. Quisque sollicitudin arcu ullamcorper libero consectetur
                       commodo. </p>
                   <p>
                   ...
                   <div class="leftGrid">
                           ...
                           <a href="product.php">
                               <div class="gbinner imgTop">
                                   <div class="gb_img_box">
                                       <img class="img-responsive fill_img" alt=""
                                           src="{{asset('assets/images/gridImage/1.png')}}">
                                   </div>
                       ...
                       <div class="boxMain ">
                           <a href="product.php">
                               <div class="gbinner imgTop">
                                   <div class="gb_img_box">
                                       <img class="img-responsive nofill_img" alt=""
                                           src="{{asset('assets/images/gridImage/2.png')}}">
                                   </div>
                       ...
                       <div class="boxMain ">
                           <a href="product.php">
                               <div class="gbinner imgTop">
                                   <div class="gb_img_box">
                                       <img class="img-responsive fill_img" alt=""
                                           src="{{asset('assets/images/gridImage/3.png')}}">
                                   </div>
                                   <div class="gb_cont_box ">
                                       <h2>Have it your way</h2>
                                       <p><i>Bansal and Sons Jewellers Jewellery Now available in white gold, rose gold
                                               or yellow gold</i></p>
                       ...
                       <div class="boxMain ">
                           <a href="product.php">
                               <div class="gbinner imgRight clearfix">
                                   <div class="gb_img_box ">
                                       <img class="img-responsive nofill_img" alt=""
                                           src="{{asset('assets/images/gridImage/4.png')}}">
                                   </div>
                                   <div class="gb_cont_box">
                       ...
                       <div class="boxMain ">
                           <a href="product.php">
                               <div class="gbinner imgLeft clearfix">
                                   <div class="gb_img_box ">
                                       <img class="img-responsive nofill_img" alt=""
                                           src="{{asset('assets/images/gridImage/5.png')}}">
                                   </div>
                                   <div class="gb_cont_box">
                                       <h2>Smile from Ear to Ear</h2>
                                       <p><i>Choose from our exclusive collection of diamond earrings</i></p>
                       ...
                       <div class="boxMain ">
                           <a href="product.php">
                               <div class="gbinner imgTop">
                                   <div class="gb_img_box">
                                       <img class="img-responsive fill_img" alt=""
                                           src="{{asset('assets/images/gridImage/6.png')}}">
                                   </div>
                                   <div class="gb_cont_box ">
                   ...
                   <div class="productInner row m0">
                       <div class="row m0 imgHov">
                           ...
                           <div class="row m0 hovArea">
                               ...
                               <div class="row m0 proPrice"><i
                                       class="fas fa-rupee-sign"></i>{{$home_product->product_price}}.00</div>
                           </div>
                       </div>
           ...
           <div class="row">
               ...
               <div class="col-sm-3 product">
                   <div class="productInner row m0">
                       ...
                       <div class="row m0 proName"><a
                               href="{{url('category',$category->products_categories_id)}}">{{$category->name}}</a>
                       </div>
                       <div class="row m0 proBuyBtn">
                       </div>
                   </div>
           ...
           <div class="row">
               <div class="tab-content testiTabContent">
                   <div role="tabpanel" class="tab-pane active" id="testi1">
                       <p><span class="t_q_start">“</span> Bansal and Sons Jewellers is really excellent site for
                           jewellery. I am very happy with the Bansal and Sons Jewellers products and dedicated services
                           from them. Bansal and Sons Jewellers is really excellent site for jewellery. <span
                               class="t_q_end">”</span></p>
                       <h5 class="customerName">Dwayne johnson</h5>
                   </div>
                   <div role="tabpanel" class="tab-pane" id="testi2">
                       <p><span class="t_q_start">“</span> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                           Vestibulum vestibulum justo accumsan felis faucibus vestibulum. Integer a ex orci. Cras sit
                           amet efficitur nisl, et vestibulum orci. <span class="t_q_end">”</span></p>
                   ...
                   <div role="tabpanel" class="tab-pane" id="testi4">
                       <p><span class="t_q_start">“</span> Donec in velit eget lacus convallis dapibus. Nulla ultrices
                           nulla sit amet justo pretium, ut tristique diam ultrices. Nunc efficitur mauris sit amet
                           imperdiet <span class="t_q_end">”</span></p>
